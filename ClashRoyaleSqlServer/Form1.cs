...
namespace ClashRoyaleSqlServer
{
    public partial class Form1 : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "INSERT INTO Jugador (nombre, codigo, puntosEstelares, experiencia, idDesafio, idLibro, idClan, idTorneo, idPase, idCaminoTrofeo, idCaminoLeyenda) " +
                "values('" + nombre + "', '" + codigo + "', '" + puntosEstelares + "', '" + experiencia + "', '" + idDesafio + "', '" + idLibro +
        ...
        private void btnModificar_Click_1(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Jugador SET nombre = '" + nombre + "',codigo = '" + codigo + "',puntosEstelares = '" + puntosEstelares +
                 "',experiencia = '" + experiencia + "'" + ",idDesafio = '" + idDesafio +
        ...
        private void ligaToolStripMenuItem1_Click(object sender, EventArgs e)
        {
